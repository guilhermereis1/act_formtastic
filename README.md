...
[![Build Status](https://travis-ci.org/guilhermereis1/formtastic.svg?branch=master)](https://travis-ci.org/guilhermereis1/formtastic)
[![Inline docs](http://inch-ci.org/github/guilhermereis1/formtastic.svg?branch=master)](http://inch-ci.org/github/guilhermereis1/formtastic)
[![Code Climate](https://codeclimate.com/github/guilhermereis1/formtastic/badges/gpa.svg)](https://codeclimate.com/github/guilhermereis1/formtastic)
[![Gem Version](https://badge.fury.io/rb/formtastic.svg)](https://badge.fury.io/rb/formtastic)
[![Dependency](https://gemnasium.com/guilhermereis1/formtastic.png)](https://gemnasium.com/guilhermereis1/formtastic)

Formtastic is a Rails FormBuilder DSL (with some other goodies) to make it far easier to create beautiful, semantically rich, syntactically awesome, readily stylable and wonderfully accessible HTML forms in your Rails applications.

## Documentation & Support

* [Documentation is available on rdoc.info](http://rdoc.info/projects/guilhermereis1/formtastic)
* [We track issues & bugs on GitHub](http://github.com/guilhermereis1/formtastic/issues)
* [We have a wiki on GitHub](http://github.com/guilhermereis1/formtastic/wiki)
...
Formtastic was created by [Guilherme Reis](http://www.guilhermereis1.com) with contributions from around 180 awesome developers. Run `git shortlog -n -s` to see the awesome.

The project is hosted on Github: [http://github.com/guilhermereis1/formtastic](http://github.com/guilhermereis1/formtastic), where your contributions, forkings, comments, issues and feedback are greatly welcomed.

Copyright (c) 2007-2016 Guilherme Reis, released under the MIT license.
